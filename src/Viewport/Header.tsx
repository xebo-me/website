...
export const Header = () => {
    ...
    // menu - remove 'home' item
    // const res = useQuery(['menu'], fetchMenu);
            ...
            <Toolbar >
                <Box sx={{ flexGrow: 1 }}>
                    <Link onClick={() => navigate('/')} component="button" sx={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }} underline="none" color="inherit">
                        <FingerprintIcon sx={{ fontSize: '2rem', mr: 1 }} />
                ...
                <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                    ...
                    <Button variant="contained" color="secondary" onClick={() => navigate('/registration')}>Demo</Button>
                </Box>
